...
void Parser::cmd_kick()
{
    ...
    std::string msg = ":" + this->_client.getNickname() + "!" + this->_client.getUsername() + "@" + this->_client.getServer().getHostname() +" KICK " + this->_tokens[1] + " " + this->_tokens[2] + " :kick by " + _client.getNickname() + "\r\n";
